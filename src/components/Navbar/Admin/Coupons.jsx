...
const Coupons = () => {
  ...
  const promotions = [
    "Combo 1: Mix Berliner  2 Pcs (Dark Choco Mousse Berliner) and Origanal South Indian Frappe (350 ML) at a special price of 325",
    "Combo 2: Kaapicino (350 Ml) and South Indian Filter Kaapi (150 ML) at a special price of 413",
    "Combo 3: Coconut Natkhatai (with Egg) and Baked Vada Pav at a special price of 403",
    "Combo 4: Mix Tartlet 9 Pcs (Salted Caramel Tartlet) and Cappucino (250 ML) at a special price of 222",
    "Combo 5: Mix Berliner  2 Pcs (Blueberry Cheese Cake Berliner) and South Indian Filter Kaapi (250 ML) at a special price of 219",
  ];
  return (
